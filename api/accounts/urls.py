...
from .views.profile_image_VIEWS import ProfileImageViewSet
...
from .views.authVIEWS import LoginAPIView, LogoutAPIView, TokenObtainCaptchaView
from .views.captchaVIEWS import challenge as captcha_challenge, verify as captcha_verify
...
router.register(r'profile-image', ProfileImageViewSet, basename='profileimage')
# router.register(r'register', RegisterView, basename='register')

urlpatterns = [
    path('captcha/challenge/', captcha_challenge, name='api_captcha_challenge'),
    path('captcha/verify/', captcha_verify, name='api_captcha_verify'),
    path('login/', LoginAPIView.as_view(), name='api_login'),
    path('logout/', LogoutAPIView.as_view(), name='api_logout'),
    path('token/', TokenObtainCaptchaView.as_view(), name='api_token'),
